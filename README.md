...
The first graph shows the reltionship between whether or not students pregame for a party based on the location of the party and it is split into male and female. The secodn grpah shows the relationship between campus involvment and where studetns prefer to attend parties. 
